  ...
  <div class="centered-container">
    <md-content class="md-elevation-3">
      ...
      <div class="title">
        ...
        <div class="md-title">Sistema Bibliotécario</div>
        <div class="md-body-1">Utilizando Java Spring Boot, Vue.js, Mysql e Material UI</div>
      </div>
  ...
  methods: {
    auth() {
      if(this.login.email == "admin" && this.login.password == "quero10"){
        this.login.email = "logado";
      }else{
        this.login.email = "errado";
      }
     }
  }
}
